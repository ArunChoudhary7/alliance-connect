            ...
            <div className="px-6 space-y-4">
              ...
              <div className="pt-4 mt-2 border-t border-white/5 text-center">
                ...
                <p className="text-xs font-medium">
                  Alternatively, you can mail us at <a href="mailto:arunc0799@gmail.com" className="text-primary hover:underline">arunc0799@gmail.com</a>
                </p>
              </div>
            </div>
          </SheetContent>
                ...
                <div className="text-center w-full">
                  ...
                  {!(profile?.username === 'arun' || profile?.role === 'admin') && (
                    <div className="space-y-3">
                      ...
                      <Button
                        onClick={() => {
                          window.location.href = `mailto:arunc0799@gmail.com?subject=Verification Payment Issue: @${profile?.username}&body=I have paid for verification but my status is still pending. My User ID: ${profile?.user_id}`;
                        }}
                        variant="outline"
                        className="w-full h-10 rounded-xl text-xs font-bold bg-white/5 hover:bg-white/10 border-white/10"
                      >
                        Mail us at arunc0799@gmail.com
                      </Button>
                        ...
                        <div className="mt-4">
                          <Button
                            onClick={async () => {
                              ...
                              setTimeout(() => {
                                window.location.href = `mailto:arunc0799@gmail.com?subject=New Verification Request: @${profile?.username}&body=I have paid Rs 49 for verification. My User ID: ${profile?.user_id}. Please verify my badge.`;
                                setIsVerifying(false);
                              }, 1000);
                            }}
